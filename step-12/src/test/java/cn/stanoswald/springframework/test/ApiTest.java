...
import cn.stanoswald.springframework.aop.ClassFilter;
import cn.stanoswald.springframework.aop.MethodMatcher;
import cn.stanoswald.springframework.aop.TargetSource;
import cn.stanoswald.springframework.aop.aspectj.AspectJExpressionPointcut;
...
import cn.stanoswald.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor;
...
import cn.stanoswald.springframework.test.bean.UserServiceBeforeAdvice;
...
public class ApiTest {
    ...
    public void test_advisor() {
        ...
        advisor.setExpression("execution(* cn.stanoswald.springframework.test.bean.IUserService.*(..))");
