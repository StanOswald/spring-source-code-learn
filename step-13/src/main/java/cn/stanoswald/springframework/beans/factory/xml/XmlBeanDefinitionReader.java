package cn.stanoswald.springframework.beans.factory.xml;
...
import cn.stanoswald.springframework.beans.factory.support.AbstractBeanDefinitionReader;
import cn.stanoswald.springframework.beans.factory.support.BeanDefinitionRegistry;
import cn.stanoswald.springframework.context.annotation.ClassPathBeanDefinitionScanner;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException, DocumentException {
        ...
        for (Element bean : beanList) {
            ...
            String beanName = StrUtil.isNotEmpty(className) ? id : name;
